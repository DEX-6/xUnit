...
@Categories.IncludeCategory(MyCategories.NegativeTest.class)
@Categories.ExcludeCategory(MyCategories.IgnoreTest.class)
public class NegativeTestsExcludeIgnoreTests {
}
